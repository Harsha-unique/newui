...
const Consulting: React.FC = () => {
  const [activeLink, setActiveLink] = useState('Consulting');
  useEffect(() => {
    AOS.init({
      duration: 500,
      offset: 120,
  ...
  return (
    <section id="consulting" className="mt-0 pt-0">
      {/* Banner Section */}
      <div
      ...
      >
        ...
        <div className="position-relative z-1">
          <h1 className="display-4 fw-bold">Consulting</h1>
          <p className="mt-2 fs-6">
            <Link to="#" className="text-white-50 text-decoration-none">Home</Link> &nbsp; - &nbsp;
            <span className="text-orange fw-semibold">Consulting</span>
          </p>
        </div>
      </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-9 ps-lg-4 lh-lg">
            <div style={{ maxWidth: '95%', textAlign: 'justify' }}>
              <h2 className="text-success mb-4">Consulting</h2>
              <p className="text-secondary mb-4">
                We deliver resilient, scalable, and secure consulting services to support enterprise-grade applications and digital transformation initiatives. Our core competencies include:
              </p>
