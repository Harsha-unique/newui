...
const Technologys: React.FC = () => {
  const [activeLink, setActiveLink] = useState('Technology');
  useEffect(() => {
    AOS.init({
      duration: 500,
      offset: 120,
  ...
  return (
    <section id="technologys" className="mt-0 pt-0">
      {/* Banner Section */}
      <div
      ...
      >
        ...
        <div className="position-relative z-1">
          ...
          <p className="mt-2 fs-6">
            ...
            <span className="text-orange fw-semibold">Technology</span>
          </p>
        </div>
      </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-9 ps-lg-4 lh-lg">
            <div style={{ maxWidth: '95%', textAlign: 'justify' }}>
              <h2 className="text-success mb-4">Technology</h2>
