...
const Enterprise: React.FC = () => {
  const [activeLink, setActiveLink] = useState('Enterprise Software');
  useEffect(() => {
    AOS.init({
      duration: 500,
      offset: 120,
  ...
  return (
    <section id="enterprise" className="mt-0 pt-0">
      {/* Banner Section */}
      <div
      ...
      >
        ...
        <div className="position-relative z-1">
          <h1 className="display-4 fw-bold">Enterprise Software Solutions</h1>
          <p className="mt-2 fs-6">
            <Link to="#" className="text-white-50 text-decoration-none">Home</Link>   -  
            <span className="text-orange fw-semibold">Enterprise Software Solutions</span>
          </p>
        </div>
      </div>
      ...
      <div className="container py-5">
        <div className="row">
          ...
          <div className="col-lg-9 ps-lg-4 lh-lg">
            <div style={{ maxWidth: '95%', textAlign: 'justify' }}>
              <h2 className="text-success mb-4">Enterprise Software Solutions</h2>
              <p className="text-secondary mb-4">
                We offer comprehensive and scalable enterprise software services designed to enhance operational efficiency, decision-making, and business agility. Our core offerings include:
              </p>
        ...
        {/* ERP Section */}
        <div className="row mt-4 align-items-start" data-aos="fade-up" data-aos-mirror="true">
        ...
        {/* CRM Section */}
        <div className="row mt-5 align-items-start" data-aos="fade-up" data-aos-mirror="true">
