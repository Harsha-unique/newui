...
const TechnologyInfrastructure: React.FC = () => {
  const [activeLink, setActiveLink] = useState('Technology Infrastructure');
  useEffect(() => {
    AOS.init({
      duration: 500,
      offset: 120,
  ...
  return (
    <section id="technology" className="mt-0 pt-0">
      {/* Banner Section */}
      <div
      ...
      >
        ...
        <div className="position-relative z-1">
          <h1 className="display-4 fw-bold">Technology Infrastructure</h1>
          <p className="mt-2 fs-6">
            <Link to="#" className="text-white-50 text-decoration-none">Home</Link>   -  
            <span className="text-orange fw-semibold">Technology Infrastructure</span>
          </p>
        </div>
      </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-9 ps-lg-4 lh-lg">
            <div style={{ maxWidth: '95%', textAlign: 'justify' }}>
              <h2 className="text-success mb-4">Technology Infrastructure</h2>
              <p className="text-secondary mb-4">
                We deliver resilient, scalable, and secure technology infrastructure services to support enterprise-grade applications and digital transformation initiatives. Our core competencies include:
              </p>
